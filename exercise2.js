...
const germanSpeakingCountries = countries.filter((element) =>
    element.languages.includes("de")
);
...
const getGermanSpeakingLangWithMostOfficialLangs = (
...
console.log(
    `The german speaking country with most official languages is: ${getCountryWithMostLangs(
    germanSpeakingCountries
  )}`
);
...
console.log(
    `Country with most official languages: ${getCountryWithMostLangs(countries)}`
);
